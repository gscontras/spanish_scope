function make_slides(f) {
 ...
 //  });
  ...
  present : [_.sample([
  {item: "ranas",
    contexts: {two: {without:"Este cuento incluye dos ranas, una cerca y una roca. Las dos ranas decidieron jugar un juego de saltos. Primero miraron la cerca, y concluyeron que la cerca era demasiado grande para saltar. Luego miraron la roca. La primera rana decidi&oacute; saltar sobre la roca, pero la otra rana pens&oacute; que la roca tambi&eacute;n era demasiado grande para saltar. <img src = \"expt_files/frogs2.png\" width = 400>", with: "<img src = \"expt_files/frogs2.png\" width = 400>"}, four: {without: "<img src = \"expt_files/frogs4.png\" width = 400>", with: "<img src = \"expt_files/frogs4.png\" width = 400>"}}, 
