function make_slides(f) {
 ...
 //  });
  ...
  present : [_.sample([
  {item: "ranas",
    contexts: {two: {without: "Este cuento incluye dos ranas, una cerca y una roca. Las dos ranas decidieron jugar un juego de saltos. Primero miraron la cerca, y concluyeron que la cerca era demasiado grande para saltar. Luego miraron la roca. La primera rana decidi&oacute; saltar sobre la roca, pero la otra rana pens&oacute; que la roca tambi&eacute;n era demasiado grande para saltar.", with: "Este cuento incluye dos ranas, una cerca y una roca. Las dos ranas decidieron jugar un juego de saltos. Primero miraron la cerca. La primera rana salt&oacute; la cerca. Entonces, la segunda rana salt&oacute; sobre la cerca. Luego miraron la roca. La primera rana decidi&oacute; saltar sobre la roca, pero la otra rana pens&oacute; que la roca era demasiado grande para saltar."}, four: {without: "Este cuento incluye cuatro ranas, una cerca y una roca. Las cuatro ranas decidieron jugar un juego de salto. Primero miraron la cerca y concluyeron que la cerca era demasiado grande para saltar. Luego miraron la roca. Las dos primeras ranas decidieron saltar sobre la roca, pero las otras dos ranas pensaron que la roca era demasiado grande para saltar.", with: "Este cuento incluye cuatro ranas, una cerca y una roca. Las cuatro ranas decidieron jugar un juego de saltos. Primero miraron la cerca. La primera rana salt&oacute; la cerca. Entonces, la segunda rana salt&oacute; sobre la cerca. Entonces la tercera y cuarta rana saltaron sobre la cerca. Luego miraron la roca. Las dos primeras ranas decidieron saltar sobre la roca, pero las otras dos ranas pensaron que la roca era demasiado grande para saltar."}}, 
    QUDs: {many: "&#191;Cu&aacute;ntas ranas saltaron sobre la roca?", all: "&#191;Saltaron todas las ranas sobre la roca?", none: "&#191;No saltaron ninguna de las ranas sobre la roca?"}, 
    goals: {many:"cu&aacute;ntas ranas saltaron sobre la roca", all:"si todas las ranas saltaron sobre la roca", none:"si no saltaron ninguna de las ranas sobre la roca"},
    ...
    sentences: {every: "\"Todas las ranas no saltaron sobre la roca.\"", numeral: "\"Dos ranas no saltaron sobre la roca.\""}},
  {item: "mariposas",
    contexts: {two: {without: "Este cuento incluye dos mariposas, un bosque y una ciudad. Las dos mariposas decid&iacute;an a d&oacute;nde ir. Primero, pensaron en el bosque. A una mariposa no le gustaba el bosque, pero a la otra s&iacute;. Decidieron no ir al bosque. La primera mariposa decidi&oacute; ir a la ciudad. La otra mariposa decidi&oacute; irse a casa.", with: "Este cuento incluye dos mariposas, un bosque y una ciudad. Las dos mariposas decid&iacute;an a d&oacute;nde ir. Primero, pensaron en el bosque y decidieron ir. A una mariposa no le gustaba el bosque, pero a la otra s&iacute;. La mariposa a la que no le gustaba el bosque decidi&oacute; dejar el bosque e ir a la ciudad. La otra mariposa decidi&oacute; dejar el bosque e irse a casa."}, four: {without: "Este cuento incluye cuatro mariposas, un bosque y una ciudad. Las cuatro mariposas decid&iacute;an a d&oacute;nde ir. Primero, pensaron en el bosque. A dos mariposas no les gustaba el bosque, pero a las otras dos s&iacute;. Decidieron no ir al bosque. Las dos primeras mariposas decidieron ir a la ciudad. Las otras dos mariposas decidieron quedarse en casa.", with: "Este cuento incluye cuatro mariposas, un bosque y una ciudad. Las cuatro mariposas decid&iacute;an a d&oacute;nde ir. Primero, pensaron en el bosque y decidieron irse. A dos de las mariposas no les gustaba el bosque, pero a las otras dos s&iacute;. Las mariposas a las que no les gustaba el bosque decidieron dejar el bosque e ir a la ciudad. Las otras dos mariposas decidieron dejar el bosque e irse a casa."}}, 
    QUDs: {many: "&#191;Cu&aacute;ntas mariposas fueron a la ciudad?", all: "&#191;Todas las mariposas fueron a la ciudad?", none: "&#191;No fue ninguna de las mariposas a la ciudad?"}, 
    goals: {many:"cu&aacute;ntas mariposas fueron a la ciudad", all:"si todas las mariposas fueron a la ciudad", none:"si no fue ninguna de las mariposas a la ciudad"},
    ...
    sentences: {every: "\"Todas las mariposas no fueron a la ciudad.\"", numeral: "\"Dos mariposas no fueron a la ciudad.\""}},
  {item: "leones",
    contexts: {two: {without: "Este cuento incluye dos leones, huevos, galletas y una tienda. Los dos leones fueron a la tienda. Le preguntaron al due&ntilde;o qu&eacute; ten&iacute;a para comer. El due&ntilde;o de la tienda les mostr&oacute; huevos y galletas. El primer le&oacute;n compr&oacute; una galleta. El otro le&oacute;n no compr&oacute; nada.", with: "Este cuento incluye dos leones, huevos, galletas y una tienda. Los dos leones fueron a la tienda en busca de algo para comer. Vieron huevos y galletas. Cada uno de los dos leones compr&oacute; un huevo, y uno de los leones tambi&eacute;n compr&oacute; una galleta."}, four: {without: "Este cuento incluye cuatro leones, huevos, galletas y una tienda. Cuatro leones fueron a la tienda. Le preguntaron al due&ntilde;o de la tienda qu&eacute; comida estaba vendiendo. El due&ntilde;o de la tienda les mostr&oacute; huevos y galletas. Los dos primeros leones compraron una galleta. Los otros dos leones no compraron nada.", with: "Este cuento incluye cuatro leones, huevos, galletas y una tienda. Los cuatro leones fueron a la tienda en busca de algo para comer. Vieron huevos y galletas. Los cuatro leones compraron huevos, y dos de los leones compraron galletas."}}, 
    QUDs: {many: "&#191;Cu&aacute;ntos leones compraron una galleta?", all: "&#191;Todos los leones compraron una galleta?", none: "&#191;No compraron ninguno de los leones una galleta?"}, 
    goals: {many:"cu&aacute;ntos leones compraron una galleta", all:"si todos los leones compraron una galleta", none:"si no compraron ninguno de los leones una galleta"},
    ...
    sentences: {every: "\"Todos los leones no compraron una galleta.\"", numeral: "\"Dos leones no compraron una galleta.\""}},
  {item: "dinosaurios",
    contexts: {two: {without: "Este cuento incluye dos dinosaurios, insectos y peces. Los dos dinosaurios ten&iacute;an hambre y buscaban comida. Los dinosaurios vieron algunos peces en el r&iacute;o, pero decidieron que eran demasiado dif&iacute;ciles de atrapar. Un dinosaurio decidi&oacute; comer un insecto porque los insectos son f&aacute;ciles de atrapar. El otro dinosaurio no comi&oacute; nada.", with: "Este cuento incluye dos dinosaurios, insectos y peces. Los dos dinosaurios ten&iacute;an hambre y buscaban comida. Cada dinosaurio se comi&oacute; un pez porque los peces son f&aacute;ciles de atrapar. Los dinosaurios luego vieron algunos insectos. Un dinosaurio todav&iacute;a ten&iacute;a hambre, por lo que decidi&oacute; comer tambi&eacute;n un insecto. El otro dinosaurio estaba demasiado lleno despu&eacute;s de comer el pescado, as&iacute; que no comi&oacute; nada m&aacute;s."}, four: {without: "Este cuento incluye cuatro dinosaurios, insectos y peces. Los cuatro dinosaurios ten&iacute;an hambre y buscaban comida. Los dinosaurios vieron algunos peces en el r&iacute;o, pero decidieron que eran demasiado dif&iacute;ciles de atrapar. Dos dinosaurios decidieron comer insectos porque los insectos son f&aacute;ciles de atrapar. Los otros dos dinosaurios no comieron nada.", with: "Este cuento incluye cuatro dinosaurios, insectos y peces. Los cuatro dinosaurios ten&iacute;an hambre y buscaban comida. Cada dinosaurio se comi&oacute; un pez porque los peces son f&aacute;ciles de atrapar. Los dinosaurios luego vieron algunos insectos. Dos dinosaurios todav&iacute;a ten&iacute;an hambre, por lo que decidieron comer tambi&eacute;n insectos. Los otros dos dinosaurios estaban demasiado llenos despu&eacute;s de comer el pescado, por lo que no comieron nada m&aacute;s."}}, 
    QUDs: {many: "&#191;Cu&aacute;ntos dinosaurios comieron insectos?", all: "&#191;Todos los dinosaurios comieron insectos?", none: "&#191;No comieron ninguno de los dinosaurios insectos?"}, 
    goals: {many:"cu&aacute;ntos dinosaurios comieron insectos", all:"si todos los dinosaurios comieron insectos", none:"si no comieron ninguno de los dinosaurios insectos"},
    ...
    sentences: {every: "\"Todos los dinosaurios no comieron insectos.\"", numeral: "\"Dos dinosaurios no comieron insectos.\""}},
  // {item: "pigs",
